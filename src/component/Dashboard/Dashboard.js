                ...
                <div className='row'>
                    <div class="col-md-3 col-lg-2 col-3 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{ backgroundColor: "#212529" }}>
                        <ul class="nav flex-column sticky-top pl-0 pt-5 mt-3 ">
                            <Nav class="nav-item mb-2 fs-5 fw-bold  text-muted"><Link to='/dashboard' class="nav-element nav-link text-secondary">My Profile</Link></Nav>
                            {
                                !admin && <>
                            ...
                            {
                                admin && <>
                                    <Nav class="nav-item mb-2 fs-5 fw-bold  text-muted"><Link to='/dashboard/users' class="nav-element nav-link text-secondary">Make Admin</Link></Nav>
